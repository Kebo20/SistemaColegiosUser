        ...
        <div id="main-wrapper">
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <% for (Calificacion cal : matriculaclase.getIdclase().getCalificacionList()) {%> 
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="myadmin-dd dd" id="nestable">
                                        <ol class="dd-list">
                                            ...
                                            <%if (nota.getIdmatriculaclase().getIdmatricula().getIdalumno().getId() == matriculaclase.getIdmatricula().getIdalumno().getId() && nota.getIdperiodo().getId() == p.getId()) {%>
                                            <%i++;%>
