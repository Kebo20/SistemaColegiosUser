...
<html lang="en">
    ...
    <body class="fix-header fix-sidebar card-no-border">
        ...
        <%
            ...
            String nombre = "";
            int id = 0;
            int ma = Integer.parseInt(request.getParameter("a"));
            Alumno alumno = null;
                            ...
                            <div class="card card-inverse card-success">
                                <div class="card-body">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <form action="clase-alumno.jsp" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive m-t-40">
                                        <table id="tableCalificacion" class="full-color-table full-inverse-table hover-table text-center color-bordered-table inverse-bordered-table color-table inverse-table display nowrap table table-hover  table-bordered text-dark" cellspacing="0" width="100%">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Competencia</th>
                                                        ...
                                                        <%for (Periodo pd : pc.findPeriodoEntities()) {%>
                                            ...
                                            <%for (Clase cl : cjc.listarxmatricula(matricula.getId())) {%>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <%for (Notas n : nc.calificacion_periodo_matriculaclase(pd.getId(), cal.getId(), Integer.parseInt(matricula.getId() + cl.getId().toString()))) {%>
                                                    <%i = i + 1;%>
                                                    <% suma = suma + n.getNota(); %>
                                                ...
                                                <tr>
                                                    ...
                                                    <%Double suma2 = 0.0; %>
                                                    <%int j = 0; %>
                                                    <%for (Notas n : nc.calificacion_periodo_matriculaclase(pd.getId(), cal.getId(), Integer.parseInt("16" + cl.getId().toString()))) {%>
