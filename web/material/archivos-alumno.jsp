...
<%@page import="Servlets.ListarArchivo"%>
<%@page import="Entidades.Archivo"%>
<%@page import="javax.persistence.Persistence"%>
<%@page import="Controladores.ArchivoJpaController"%>
...
<html lang="en">
    ...
    <body class="fix-header fix-sidebar card-no-border">
        ...
        <%
            ...
            String nombre = "";
            int id = 0;
            int c = Integer.parseInt(request.getParameter("clase"));
            int ma = Integer.parseInt(request.getParameter("matricula"));
            ...
            if (session.getAttribute("rol") == "alumno" & session.getAttribute("alumno") != null) {
                ...
                if (alumno.getMatriculaList().contains(new Matricula(ma))) {
                    matriculaclase = mc.findMatriculaclase(Integer.parseInt(String.valueOf(ma) + String.valueOf(c)));
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="hidden" id="clase" value="<%=matriculaclase.getIdclase().getId()%>">
                                    <h6 class="card-subtitle"></h6>

                                    <div class="table-responsive m-t-40">
                                        <table id="tableArchivo" class="display nowrap table table-hover table-striped table-bordered  text-dark" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>Nombre</th>
                                                    <th>Descripción</th>
        ...
        <script >
            ...
            $('#tableArchivo').DataTable({
                ...
                ajax: {
                    url: "../ListarArchivo?clase=" + $("#clase").val(),
                    method: "post",
                    dataSrc: "datos"
