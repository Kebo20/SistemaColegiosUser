<%@page import="Controladores.PagoJpaController"%>
<%@page import="Entidades.Pago"%>
...
<html lang="en">
    ...
    <body class="fix-header fix-sidebar card-no-border">
        ...
        <%
            ...
            int p = Integer.parseInt(request.getParameter("pago"));
            Pago pago=null;
            Alumno alumno= null;
            if (session.getAttribute("rol") == "alumno" & session.getAttribute("alumno") != null) {
                ...
                if (alumno.getPagoList().contains(new Pago(p))) {
                    pago = pc.findPago(p);
                    session.setAttribute("pago", pago.getId());
                } else {
                                    ...
                                    <div id="imprimir">
                                        <div class="row"> 
                                            <div class="col-lg-3 left">
                                                ...
                                                <input class="form-control text-right text-dark"  readonly value="<%=pago.getNumeroComprobante() %>"  />

                                            </div>
                                            <div class="col-lg-3 left">
                                                <h5 class="card-title">Fecha: </h5>
                                                <input class="form-control text-right text-dark"  readonly value="<%=pago.getFecha() %>" />
                                            </div>
                                            <div class="col-lg-3 left">
                                                <h5 class="card-title">Alumno: </h5>
                                                <input class="form-control text-right text-dark"  readonly value="<%=alumno.getNombre() + " " + alumno.getApPaterno() + " " + alumno.getApMaterno()%>" />
                                            </div>
                                            <div class="col-lg-3 left">
                                                <h5 class="card-title">Total: </h5>
                                                <input class="form-control text-right text-dark"  readonly value="S/. <%=pago.getTotal() %>" />
                                            </div>
                                        </div>
