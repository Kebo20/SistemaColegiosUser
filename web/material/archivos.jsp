...
<html lang="en">
    ...
    <body class="fix-header fix-sidebar card-no-border">
        ...
        <script >
            $(document).on('submit', '#formRA', function () {
                ...
                $.ajax({
                    ...
                    success: function (r) {
                        ...
                        $('#tableArchivo').DataTable().ajax.reload();
                        $("#ModalRAC").modal("hide");
                        $("#cargandoR").html("");
                        $("#formRA").reset();
            ...
            $(document).on('submit', '#formELA', function () {
                $.ajax({
                    type: 'POST',
                    url: '../EliminarArchivo',
                    data: {
        ...
        <div id="ModalRAC" class="modal  fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="formRA" enctype="multipart/form-data">
                        <div class="modal-body">

                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Archivo</label>
                                <input type="file" class="form-control dropify" id="archivo" name="archivo" />
                                <input type="hidden" class="form-control" id="clase" name="clase" value="<%=c.getId()%>"  required/>
                ...
                <div class="modal-content">
                    ...
                    <form id="formELA">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="control-label text-dark">¿Está seguro de eliminar este archivo?</label>
