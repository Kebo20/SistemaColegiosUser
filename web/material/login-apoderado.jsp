...
<html lang="en">
    ...
    <body>
        ...
        <!-- ============================================================== -->
        <section id="wrapper">
            <div class="login-register" style="background-image:url(../imagenes/login-apoderado.jpg);">        
                <div class="login-box ">
                    <div class="card-body">
                        <form class="form-horizontal form-material " id="login" autocomplete="off">
                            <h3 class="box-title m-b-20 text-white text-center  font-20"><img src="../assets/images/logo-icon.png" alt="Home" /><br/><b>Apoderado</b></h3>
                            <div class="form-group ">
                                <div class="col-xs-12">
                                    <input class="form-control text-white" id="usuario" type="text" required="" autocomplete="off" placeholder="Usuario"> </div>
                            </div>
                            <div class="form-group">
                                <div class="col-xs-12">
                                    <input class="form-control text-white" id="contraseña" type="password" required=""autocomplete="off"  placeholder="Contraseña"> </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12">
...
//        processData: false,
                                success: function (result) {
                                    ...
                                    if (result === ":)") {
                                        ...
                                        window.location.replace("inicio-apoderado.jsp");
