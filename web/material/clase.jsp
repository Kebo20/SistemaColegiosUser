        ...
        <div id="main-wrapper">
            ...
            <aside class="left-sidebar">
                ...
                <div class="scroll-sidebar">
                    <!-- User profile -->
                    <div class="user-profile" style="background: url(../imagenes/bloggif_5e1e270cc44f1) no-repeat;">
                        <br>
                        <br>
                        <br>
                        <br>
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li> <a class=" waves-effect waves-dark" href="agenda-clase.jsp?clase=<%=c.getId()%>" aria-expanded="false"><i class="fa fa-bookmark"></i><span class="hide-menu">Agenda</span></a> </li>
                            <li> <a class=" waves-effect waves-dark" href="archivos.jsp?clase=<%=c.getId()%>" aria-expanded="false"><i class="fa fa-file-pdf-o"></i><span class="hide-menu">Archivos </span></a> </li>
                    ...
                    <div class="row page-titles">
                        <div class="col-md-12 col-12 align-self-center">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><%=c.getIdcurso().getNombre() + " " + c.getIdseccion().getIdgrado().getNombre() + " " + c.getIdseccion().getNombre() + " "%></li>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive m-t-40">
                                        <form action="asistencia.jsp" method='post'>
                                            ...
                                            <button class="btn btn-danger" style="position: absolute;top: 3%;right:1%">Asistencia <icon class="fa fa-calendar-check-o"></icon></button> 
                                            <input required="" type="date" name="fecha" class="btn btn-danger" style="position: absolute;top: 15%;right: 1%"> </span>
                                            <input type="hidden" id="clase" name ="clase" value="<%=c.getId()%>" required="">

                                        </form>



                                        <form action="notas-periodo.jsp" method='post'>  
                                            <input type="hidden"  name ="clase" value="<%=c.getId()%>" required="">

                                            <%
                                                PeriodoJpaController a = new PeriodoJpaController();
                                            %>
                                            <select name="periodo" class=" btn btn-skype " type="button" style="position: absolute;top: 15%;left: 1%"  required="">
                                            ...
                                            <button   class="btn btn-skype" style="position: absolute;top: 3%;left: 1%">Notas <icon class="fa fa-book"></icon></button>
                                        </form>
                                        ...
                                        <table id="tableClase" class="display nowrap table table-hover table-striped table-bordered text-left text-dark" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>Alumno</th>
                                                    <th>Anecdotario</th>
