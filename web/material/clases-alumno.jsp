    ...
    <body class="fix-header fix-sidebar card-no-border">
        ...
        <%
            ...
            if (session.getAttribute("rol") == "alumno" & session.getAttribute("alumno") != null) {
                ...
                id = alumno.getId();
                MatriculaJpaController mcc = new MatriculaJpaController();
                if (mcc.listarxalumno(id).contains(new Matricula(ma))) {
                    
                    matricula = mcc.findMatricula(ma);
                } else {
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <%CursoJpaController cuc = new CursoJpaController(); %>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <form action="clase-alumno.jsp" method="post">
                                                ...
                                                <%Curso curso = cuc.findCurso(c.getIdcurso().getId());%>
                                                <input type="submit" class="card-title btn-success font-20" value="<%=curso.getNombre()%>">
