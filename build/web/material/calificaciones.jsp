    ...
    <body class="fix-header fix-sidebar card-no-border">
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <button  data-toggle="modal" data-target="#ModalRG" class="btn btn-dropbox" style="position: absolute;top: 3%;right: 1%" >Añadir</button>
        ...
        <script >
            ...
            $('#tableCalificacion').DataTable({
                ...
                ajax: {
                    url: "../ListarCalificacion?clase=" + $("#clase").val(),
                    method: "post",
                    dataSrc: "datos"
                ...
                <div class="modal-content">
                    ...
                    <form id="formELgrado">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="control-label text-dark">¿Está seguro de eliminar este calificación?</label>
