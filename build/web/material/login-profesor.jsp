...
<body>
    ...
    <!-- ============================================================== -->
    <section id="wrapper" class="login-register login-sidebar"  style="background-image:url(../imagenes/login-profesor.jpg);">
  <div class="login-box ">
    <div class="card-body">
      <form class="form-horizontal form-material" id="login" >
          <a href="javascript:void(0)" class="text-center db"><img src="../assets/images/logo-icon.png" alt="Home" /><br/><b class="text-dark font-20">Profesor</b> </a>  
        ...
        <div class="form-group">
          <div class="col-xs-12">
            <input class="form-control" type="password" id="contraseña" required="" placeholder="Contraseña">
          </div>
        </div>
        <div class="form-group">
          <div class="col-md-12">
...
//        processData: false,
                                success: function (result) {
                                    ...
                                    if (result === ":)") {
                                        ...
                                        window.location.replace("inicio-profesor.jsp");
