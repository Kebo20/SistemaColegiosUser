            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <div class="col-md-5 col-8 align-self-center">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Notas <%=p.getDescripcion()%></li>
                            </ol>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <% for (Calificacion cal : cc.listarxclase(c.getId())) {%> 
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="myadmin-dd dd" id="nestable">
                                        <ol class="dd-list">
                                            <%SubcalificacionJpaController scc = new SubcalificacionJpaController(); %>
                                            <%for (Subcalificacion scal : scc.listarxcalificacion(cal.getId())) {%>
                                            <li class="dd-item" data-id="1">
                                                <form action="notas.jsp" method="post">
                                                    <div class="dd-handle"><button class=" btn-info btn dd-handle"><icon class="fa fa-check-circle"></icon> <%=scal.getDescripcion()%> </button></div>
                                                    <input type="hidden" name="clase" value="<%=c.getId()%>">
                                                    <input type="hidden" name="cal" value="<%=cal.getId()%>">
                                                    <input type="hidden" name="subcal" value="<%=scal.getId()%>">
                                                    <input type="hidden" name="periodo" value="<%=p.getId()%>">
                                                </form>
                                            </li>
                                            <%} %>
                                        </ol>
