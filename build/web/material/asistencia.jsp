...
<html lang="en">
    ...
    <body class="fix-header fix-sidebar card-no-border">
                    ...
                    <div class="row page-titles">
                        <div class="col-md-5 col-8 align-self-center">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Asistencia del <%=request.getParameter("fecha")%></li>
                            </ol>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="hidden" id="fecha" value="<%=request.getParameter("fecha")%>">
                                    <h6 class="card-subtitle"></h6>

                                    <div class="table-responsive m-t-40">
                                        <table id="tableAsistencia" class="display nowrap table table-hover table-striped table-bordered text-center text-dark" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>Alumno</th>
                                                    <th>Tipo</th>
        ...
        <script>
            ...
            $(document).on('submit', '#formRasistencia', function () {
            ...
            $(document).on('submit', '#formEasistencia', function () {
                $.ajax({
                    type: 'POST',
                    url: '../EditarAsistencia',
                    data: {
                        id: $("#idEA").val(),
                        idalumno: $("#idalumnoEA").val(),
                        fecha: $("#fechaEA").val(),
                        tipo: $("#tipoEA").val(),
            ...
            $(document).on('submit', '#formELasistencia', function () {
                $.ajax({
                    type: 'POST',
            ...
            $('#tableAsistencia').DataTable({
                ...
                ajax: {
                    url: "../ListarAsistencia",
                    method: "post",
                    dataSrc: "datos",
                    data: {fecha: $('#fecha').val(), clase: $('#clase').val()}
            ...
            function editarAsistencia(id, fecha, tipo, descripcion, idalumno) {
                $("#idEA").val(id);
                $("#fechaEA").val(fecha);
                $("#tipoEA").val(tipo);
                $("#tipoEA").change();
                $("#descripcionEA").val(descripcion);
                $("#idalumnoEA").val(idalumno);
                $("#idalumnoEA").change();
                $("#ModalEA").modal("show");
        ...
        <div id="ModalRA" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="formRasistencia">
                        <div class="modal-body">

                            <div class="form-group">
                                <label for="recipient-name" class="control-label"></label>
                                <input type="hidden" class="form-control" id="fechaRA" value="<%=request.getParameter("fecha")%>" readonly />
                            </div>

                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Tipo</label>
                                <select id="tipoRA" class="select2" style="width: 100%"  required="">
                                    <option value="">Selecciona una asistencia</option>
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Alumno</label>
                                <%
                                    MatriculaclaseJpaController a = new MatriculaclaseJpaController();
                                %>
                                <select id="idalumnoRA" class="select2" style="width: 100%"  required="">
                                    <option value="">Selecciona un alumno</option>

                                    <% for (Matriculaclase alumno : a.listarxclase(c.getId())) {%>

                                    <option value="<%=alumno.getIdmatricula().getIdalumno().getId()%>"><%=alumno.getIdmatricula().getIdalumno().getNombre()%> <%=alumno.getIdmatricula().getIdalumno().getApPaterno()%> <%=alumno.getIdmatricula().getIdalumno().getApMaterno()%></option>
                                    <%}%>
                                </select>
        ...
        <div id="ModalEA" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="formEasistencia">
                        <div class="modal-body">

                            <div class="form-group">
                                <input type="hidden" class="form-control" id="fechaEA" value="<%=request.getParameter("fecha")%>" readonly="" />
                                <input class="form-control" id="idEA" type="hidden" />
                            </div>

                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Tipo</label>
                                <select id="tipoEA" class="select2" style="width: 100%"  required="">
                                    <option value="">Selecciona una asistencia</option>
                                    <option value="P">Presente</option>
                                    <option value="A">Ausente</option>
                                    <option value="T">Tardanza</option>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="idalumnoEA" type="hidden" />
        ...
        <div id="ModalELA" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="formELasistencia">
                        <div class="modal-body">

                            <div class="form-group">
                                <label for="recipient-name" class="control-label text-dark">¿Está seguro de eliminar esta asistencia?</label>
