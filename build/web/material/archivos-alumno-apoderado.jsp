    ...
    <body class="fix-header fix-sidebar card-no-border">
        ...
        <%
            ...
            if (session.getAttribute("rol") == "apoderado" & session.getAttribute("apoderado") != null) {
                ...
                if (apc.validarMatricula(Integer.parseInt(matricula), apoderado.getId())) {

                    matriculaclase = mc.findMatriculaclase(Integer.parseInt(matricula + clase));
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right scale-up">
                                    <ul class="dropdown-user">
                                        ...
                                        <li><a href="#"><i class="ti-user"></i> <%=apoderado.getNombre() %></a></li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <div class="col-md-5 col-8 align-self-center">
                            <h3 class="text-themecolor"><%=apoderado.getNombre() %></h3>
                            <ol class="breadcrumb">
