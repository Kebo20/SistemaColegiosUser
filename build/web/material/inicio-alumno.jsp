...
<%@page import="Controladores.PublicacionJpaController"%>
                    ...
                    <div class="navbar-collapse">
                        ...
                        <ul class="navbar-nav my-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../../colegios/archivos/<%=alumno.getImagen()%>" alt="user" class="profile-pic" /></a>
                                <div class="dropdown-menu dropdown-menu-right scale-up">
                                    <ul class="dropdown-user">
                                        <li>
                                            <div class="dw-user-box">
                                                <div class="u-img"><img src="../../colegios/archivos/<%=alumno.getImagen()%>" alt="user"></div>
                                                <div class="u-text">
                                                    <h4><%=usuario%></h4>
                                                    <br>
                        ...
                        <ul id="sidebarnav">
                            ...
                            <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Clases </span></a>
                                <ul aria-expanded="false" class="collapse">
                                    ...
                                    <li><a  href="clases-alumno.jsp?a=<%=m.getId()%>" ><%=m.getIdano().getDescripcion()%></a>
                                        <% }%>
                                </ul>
                            </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <div class="col-md-12 col-12 align-self-center">
                            <h3 class="text-themecolor">Te damos la bienvenida, "<%=nombre%>"</h3>
                    ...
                    <div class="card-columns el-element-overlay">
                        ...
                        <%for (Publicacion p : pc.findPublicacionEntities()) {%>
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1">
                                    <a class="image-popup-vertical-fit"  href="../../colegios/archivos/<%=p.getImagen() %>"> <img src="../../colegios/archivos/<%=p.getImagen() %>" alt="imagen"  /> </a>
                                </div>
                                <div class="el-card-content">
                                    <h3 class="box-title"><%=p.getNombre() %></h3> <small><%=p.getDescripcion() %></small>
                                    <br/> </div>
                            </div>
                        </div>
                        <% }%>
