                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <form action="archivos-alumno-apoderado.jsp" method="post">
                                                <input type="hidden" name="matricula" value="<%=matriculaclase.getIdmatricula().getId()%>" >
                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <form action="notas-alumno-apoderado.jsp" method="post">
                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <form action="agenda-clase-alumno-apoderado.jsp" method="post">
                                                <input type="hidden" name="matricula" value="<%=matriculaclase.getIdmatricula().getId()%>" >
