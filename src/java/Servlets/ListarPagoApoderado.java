 ...
 * @author kevin
 */
public class ListarPagoApoderado extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
           JsonObject json = new JsonObject();
            ...
            for (Pago p: pc.listarxalumno(Integer.parseInt(request.getParameter("alumno")))) {
                ...
                j.addProperty("detalle", "<a  class='btn' href='detallePagos-alumno-apoderado.jsp?alumno="+Integer.parseInt(request.getParameter("alumno"))+"&pago="+p.getId()+"'><i class='fa fa-eye text-inverse m-r-10'></i></a>");
